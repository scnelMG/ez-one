...
| 추천 공고 | Mattermost 추천 | SSAFY 전용 활성 | SSAFY 추천 후보 |
...
| 추천 공고 | 일반 추천은 제외한다. Mattermost 추천은 SSAFY 사용자 전용 활성 흐름으로 제공한다. |
...
| 흐름 | 상태 |
| --- | --- |
| Mattermost 추천 | SSAFY 사용자 전용 활성 추천 흐름 |
| 서류 자동 입력 보조 고도화 | P2. 파일 다운로드, 사이트별 selector 대응, 다중 페이지 반복 자동화 |
